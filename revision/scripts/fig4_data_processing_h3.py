...
def run_workflow(iso_a3_code):
    logging.info(f"start calculation for h3_country_map: {iso_a3_code}")
    output_file = f'/data/processing/corporate-stats/results/h3_map_{iso_a3_code}.gpkg'
    ...
    WHERE list_contains(country_iso_a3, '{iso_a3_code}')
